...
export const tours = [
    ...
    },
    {
        ...
        reviews: [
            {
                autor: 'Ольга',
                text: 'Не довольна. Вместо разъяснений отправляют самостоятельно читать документацию. Тесты с огромным количеством ошибок, администрация на замечания не реагирует. Но даже так появляются отличники, набравшие по 100 баллов. Они явно заглядывают в будущее больше, чем на 3 секунды!',
                stars: 2,
                starsEmpty: 3,
            },
            {
